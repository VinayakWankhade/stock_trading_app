...
const Register = () => {
    ...
    const { loading, error, isAuthenticated, user, register, clearError } = useGeneral();
        ...
        <div className="flex-center min-vh-100" style={{ minHeight: '100vh', padding: '2rem', background: '#f8fafc' }}>
            <div className="pro-card animate-fade-in" style={{ width: '100%', maxWidth: '450px', padding: '3.5rem 3rem' }}>
                <div className="flex-center" style={{ marginBottom: '2rem', flexDirection: 'column' }}>
                    ...
                    <h1 style={{ fontSize: '2.25rem', color: '#1e3a8a', fontFamily: 'Outfit, sans-serif' }}>Get Started</h1>
                    <p style={{ color: 'var(--text-secondary)', fontWeight: '500' }}>Create your virtual trading account</p>
                </div>
